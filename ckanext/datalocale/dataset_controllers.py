...
from ckanext.organizations.controllers import OrganizationController
...
class DatalocaleDatasetController(BaseController):
    ...
    def read(self, id, format='html'):
        ...
        c.site_url = config.get('ckan.site_url', '')  
